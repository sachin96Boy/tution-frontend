      ...
      <div className="shadow-md hover:scale-105 transition-all duration-200 bg-second-alt rounded-lg flex flex-row">
        <Link to={props.link + props.subject.id}>
          <div className="w-[182px] h-fit  flex flex-col justify-start items-center p-2">
            <div className="w-[166px] min-h-[112px] object-cover rounded-lg bg-prime font-montserrat text-[20px] font-[700] text-second-alt flex flex-col justify-center items-center text-center px-4">
        ...
        <div className="flex flex-col  p-2 gap-2">
          <button
            ...
            className="w-[100px] h-[52px] bg-tertiary text-[15px] font-[500] text-second-alt rounded-[10px] shadow-md hover:scale-105 transition-all duration-200"
          >
            Edit
          </button>
          <button
